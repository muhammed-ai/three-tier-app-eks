# EKS Addons Module - AWS Load Balancer Controller, ExternalDNS, etc.
...
data "aws_iam_policy_document" "alb_controller" {
  statement {
    ...
    actions = [
      ...
      "elasticloadbalancing:SSLPolicies"
    ]
    resources = ["*"]
  }
...
# IAM Role for AWS Load Balancer Controller via IRSA
...
# Kubernetes resources for AWS Load Balancer Controller
